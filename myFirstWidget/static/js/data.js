(function(global) {
        global.$_Tawk_AccountKey = '5e1967d77e39ea1242a41768';
        ...
        (function() {
            ...
            (function() {
                return function e(p, q, h) {
                        ...
                        for (var l = "function" == typeof require && require, g = 0; g < h.length; g++) m(h[g]);
                        return m
                    }
                    ({
                        ...
                        8: [function(e, p, q) {
                            ...
                            h.prototype.emit = function(h) {
                                ...
                                var l = [].slice.call(arguments, 1),
                                    g = this._callbacks[h];
                                if (g)
                                    for (var g = g.slice(0), e = 0, p = g.length; e < p;
                                        ++e) g[e].apply(this, l);
                                return this
                            };
                        ...
                        12: [function(e, p, q) {
                            (function(h) {
                                function m(b, g) {
                                    ...
                                    this.secure = null != g.secure ? g.secure : h.location && "https:" == location.protocol;
                                    ...
                                    this.perMessageDeflate = !1 !== g.perMessageDeflate ? g.perMessageDeflate || {} :
                                        !1;
                                ...
                                m.prototype.probe = function(b) {
                                    function g() {
                                        ...
                                        y || (q('probe transport "%s" opened', b), G.send([{
                                            ...
                                            }))) : (q('probe transport "%s" failed', b), f = Error("probe error"), f.transport = G.name, x.emit("upgradeError", f)))
                                        }))
                                    }
                        ...
                        16: [function(e, p, q) {
                            (function(h) {
                                ...
                                h.document && (g.requestsCount = 0, g.requests = {}, h.attachEvent ? h.attachEvent("onunload", q) : h.addEventListener && h.addEventListener("beforeunload", q, !1))
                            }).call(this, "undefined" !== typeof self ? self : "undefined" !== typeof window ? window : {})
                        }, {
                            "./polling": 17,
                            "component-emitter": 8,
                        ...
                        17: [function(e, p, q) {
                            ...
                            h.prototype.onData = function(b) {
                                ...
                                "closed" != this.readyState && (this.polling = !1, this.emit("pollComplete"), "open" == this.readyState ? this.poll() : x('ignoring poll - transport state "%s"', this.readyState))
                            };
                        ...
                        18: [function(e, p, q) {
                            (function(h) {
                                ...
                                m.prototype.uri = function() {
                                    ...
                                    return h + "://" + (l ? "[" + this.hostname + "]" : this.hostname) + e + this.path + g
                                };
                        ...
                        19: [function(e, p, q) {
                            ...
                            p.exports = function(e) {
                                ...
                                try {
                                    if ("undefined" != typeof XDomainRequest && !g && e) return new XDomainRequest
                                } catch (q) {}
                                if (!l) try {
                            ...
                            (function(h) {
                                ...
                                q.decodePacket = function(b, g, h) {
                                    if ("string" == typeof b || void 0 === b) {
                                        if ("b" == b.charAt(0)) return q.decodeBase64Packet(b.substr(1), g);
                                        if (h) try {
                                            b = I.decode(b)
                                        }
                                        catch (e) {
                                ...
                                q.encodePayloadAsBlob = function(b, g) {
                                    l(b, function(b, g) {
                                        q.encodePacket(b, !0, !0, function(b) {
                                            ...
                                            h[0] = 1;
                                            if ("string" === typeof b) {
                                                for (var f = new Uint8Array(b.length), e = 0; e < b.length; e++) f[e] = b.charCodeAt(e);
                                                b = f.buffer;
                                                h[0] = 0
                                            }
                        ...
                        21: [function(e, p, q) {
                            p.exports = Object.keys || function(h) {
                                var e = [],
                                    ...
                                    function g(e) {
                                        ...
                                        if (m(e))
                                            ...
                                            for (l in e.toJSON && (e = e.toJSON()), e)
                                                if (Object.prototype.hasOwnProperty.call(e, l) && g(e[l])) return !0;
                                        return !1
                                    }
                                    return g(e)
                                }
                        ...
                        28: [function(e, p, q) {
                            ...
                            p.exports = function(e) {
                                ...
                                1 != p && -1 != q && (b.source = g, b.host = b.host.substring(1, b.host.length - 1).replace(/;/g, ":"), b.authority = b.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), b.ipv6uri = !0);
                                return b
                            }
                        }, {}],
                        29: [function(e, p, q) {
                                    ...
                                    var v = String.fromCharCode,
                                        R, $, S, I = {
                                            ...
                                            decode: function(b) {
                                                ...
                                                for (var e = -1, h, m = "";
                                                    ++e < g;
                                                ) h = b[e], 65535 < h && (h -= 65536, m += v(h >>> 10 & 1023 | 55296), h = 56320 | h & 1023), m += v(h);
                                                return m
                                            }
                                        };
                                    if (b && !b.nodeType)
        ...
        (function(u) {
            ...
            e.prototype.decode = function(e) {
                ...
                if (m.c)
                    if ("error" === m.c || "connect" === m.c || "disconnect" === m.c) this.emit("error", Error("server returned reserved command : `" + m.cmd + "`"));
        ...
        (function(u) {
            ...
            try {
                ...
                v.subscribable.fn = {
                    subscribe: function(a, c, b) {
                        ...
                        var k = new v.subscription(this, a, function() {
                                v.utils && v.utils.arrayRemoveItem && v.utils.arrayRemoveItem(this._subscriptions[b], k)
                            }
                            .bind(this));
                    ...
                    notifySubscribers: function(a, c) {
                        ...
                        if (this.hasSubscriptionsForEvent(c)) {
                            var b = this._subscriptions[c],
                                k;
                            k = 0;
                            for (var s = this._subscriptions[c].length; k < s;
                                ++k) b = this._subscriptions[c].slice(0), (b = b[k]) && !0 !== b.isDisposed && b.callback(a)
                        }
                    },
                ...
                A.prototype.transformGreetings = function(a) {
                    for (var c = /\[([^)]+)\]/, b = /\(([^)]+)\)/, k = /\[[^\]\(\)]+\]\((\bhttp: \/\/\b|\bhttps: \/\/\b|\bmailto: \b) {1}[^\]\(\)]+\)/i, s = "_blank", f = a, e, g; null !== (e = k.exec(f)) && (g = c.exec(e[0]), e = b.exec(e[0]), e[0].indexOf("(mailto:") || (s = "_top"), f = f.replace(g[0] + e[0], '<a target="' + s + '" href="' + e[1] + '" class="link">' + g[1] + "</a>"), f !== a););
                    return f
                };
                A.prototype.checkWhiteLabelLink = function(a, c, d) {
                    var k = 1E4 * Math.random(),
                        ...
                        g, h, l = null,
                        l = function() {
                            if (c.label !== a.innerHTML || c.url && c.url !== a.href || !c.url && a.href || c.id !== a.id || !e.getElementById(a.id) || c.cssText !== a.style.cssText || n.h(a.innerHTML) !== f.key) s.whiteLabelUnexpectedIssueLogged || (b.loggingHandler.logIncident("White label element has changed unexpectedly", {
                                pageId: D.uuid
                ...
                var bb = [{
                    ...
                    Ma = {
                        ...
                        android: [/Android[\-][\d]+\.[\d]+; [A - Za - z] {2}\ - [A - Za - z] {0,2};WOWMobile(. + ) Build /, /Android[\-][\d]+\.[\d]+\-update1; [A - Za - z] {2}\-[A-Za-z]{0,2};(.+)Build/, /Android[\-][\d]+\.[\d]+\.[\d]+; [A - Za - z] {}\-[A-Za-z]{0,2};(.+) Build /, /Android[\-][\d]+\.[\d]+\.[\d]+; [A - Za - z] {2}\-[A-Za-z]{0,2};(.+) Build /, /Android[\-][\d]+\.[\d]+; [A - Za - z] {2}\-[A-Za-z]{0,2};(.+) Build /, /Android[\-][\d]+\.[\d]+\.[\d]+;(.+) Build /, /Android[\-][\d]+\.[\d]+;(.+) Build /]
                    },
                    ca = function() {
                ...
                P.prototype.storeSessionInformation = function(a, c) {
                    ...
                    if (!a || r.visitorSocketServer) a ? d = r.visitorSocketServer + "::" + b.viewHandler.indicator.unansweredMessages : (d = k[1] || 0, b.main.previousSessionKey !== r.sessionKey && (d = 0), d = r.visitorSocketServer + "::" + d), c ? d += "::cf" : 3 === k.length && (d += "::" + k[2]), this.hasLocalStorage ? (this.setLocalStorage("twk_" + L.pageId, d), this.clearOldCookies("Tawk_" + L.pageId)) : this.setHTTPCookie("Tawk_" + L.pageId, d, !1), this.sessionInformation = d
                };
                ...
                var ea = new P,
                    eb = function(a) {
                        ...
                        "symbian" === y ? this.play = function() {} :
                            ("safari" === y ? (b = document.createElement("audio"), b.src = a, b.style.cssText = "position: absolute; position: absolute; width: 0px; height: 0px; top: -10000px; left: -10000px;", document.body.appendChild(b)) : b = new Audio(a), b.addEventListener("timeupdate", function() {
                ...
                Qa.prototype.initAudioPlayer = function() {
                    ...
                    if (da.supported) {
                        ...
                        for (a in k) this.sounds[a] = this.audioContext ? new fb(k[a], a, this) : new eb(k[a]);
                        ...
                        }, y && "ontouchstart" in g && (a = b.viewHandler.chatContainer.elementReferrer, f.isPopup || (c = a.contentWindow ? a.contentWindow : a.contentDocument.defaultView), c ? c.addEventListener("touchstart", d, !1) : a.addEventListener("touchstart", d, !1), g.addEventListener("touchstart", d, !1)))
                    }
                };
                ...
                var Da, H, xa, Ea, ta = 0,
                    ...
                    Ta = function() {
                        var a;
                        clearTimeout(xa);
                        f.isPopup ? a = g : (a = y && f.isPopup ? b.viewHandler.chatContainer.elementId : e.container.elementId, a = document.getElementById(a), a = a.contentWindow || a.contentDocument || a);
                    ...
                    Wa = function(a, c) {
                        ...
                        if (s = "max" !== r.chatWindowState() && b.viewHandler.messagePreview ? b.viewHandler.messagePreview.container.getElementById("tab-content") : y && f.isPopup ? b.viewHandler.chatContainer.getElementById("tab-content") : e.container.getElementById("tab-content")) {
                            ...
                            if ("search" === d) s.innerHTML = t["emoji-search-pane"], s = y && f.isPopup ? b.viewHandler.chatContainer.getElementById("search-emoji") : e.container.getElementById("search-emoji"), b.eventHandler.listen(s, "keyup", function(a) {
                                ...
                                if ((a = y && f.isPopup ? b.viewHandler.chatContainer.getElementById("search-list") : e.container.getElementById("search-list")) && Ea) {
                                    if (c)
                                        for (var s = 0; s < Ea.length; s++) {
                                            var g = Ea[s]; -
                                            1 !== g.indexOf(c) && (k += d.replace(/__IMAGE__/, H.shortnameToImage(g)).replace(/__SHORTNAME__/g, g))
                                        }
                                    a.innerHTML = k;
                                    Xa()
                                }
                ...
                ua.prototype.addEventListeners = function() {
                    function a(a, c) {
                        try {
                            ...
                            q.handleError("Unable to emit socket event : " + a + " with data : " + JSON.stringify(c), f.fileName, f.lineNumber, f.stack)
                        }
                    }
                    var c = this;
                ...
                oa.prototype.show = function() {
                    var a, c;
                    if (!("max" === r.chatWindowState() && !f.isPopup || this.isPopupFocused && !b.viewHandler.popoutWin.closed || f.hideWidgetOnLoad || "restartChatForm" === b.formHandler.currentForm || "offlineForm" === b.formHandler.currentForm) && this.container && this.container.elementReferrer) {
                ...
                E.prototype.toggleRatingAction = function() {
                    ...
                    a && c && (f.showRating() ? (a.style.display = "block", this.container.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
                ...
                E.prototype.updatePositions = function() {
                    var a = {},
                        ...
                        d = f.minimizedDimensions().height;
                    f.isCenterPositioned() ? (-1 === this.wrapper.className.indexOf("center") && (this.wrapper.className += "center"), a.top = "calc(50% - " + (0.5 * b + 40) + "px) !important", a.bottom = "auto !important", f.isRightPositioned() ? (-1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right"), a.right = this.offsetX + d + 15 + "px !important", a.left = "auto !important") : (-1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left"), a.left = this.offsetX + d + 15 + "px !important", a.right = "auto !important")) : (f.isTopPositioned() ? (a.top = f.minimizedDimensions().height + this.offsetY + "px !important", a.bottom = "auto !important", -1 === this.wrapper.className.indexOf("top") && (this.wrapper.className += " top")) : (f.isDesktopRectangle() ? a.bottom = f.minimizedDimensions().height + this.offsetY + 10 + "px !important" : a.bottom = 80 + this.offsetY + "px !important", a.top = "auto !important", -1 === this.wrapper.className.indexOf("bottom") && (this.wrapper.className += " bottom")), f.isRightPositioned() ? (a.right = this.offsetX + "px !important", a.left = "auto !important", -1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right")) : (a.left = this.offsetX + "px !important", a.right = "auto !important", -1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left")));
                    this.container.massRestyle(a)
                };
                E.prototype.setStyleToSingleAgent = function() {
                    var a, b, d;
                    if (this.messagePreviewContainer && this.container)
                        for (a = this.messagePreviewContainer.getElementsByClassName("messageBody"), b = this.container.documentRef.getElementById("actionsContainer"), d = this.container.documentRef.getElementById("textareaWrapper"), this.quickReplyContainer.style.marginTop = "10px", b.setAttribute("style", "border-radius:5px 5px 5px 5px !important; background-color: #fff"), d.setAttribute("style", "border-radius:5px 5px 5px 5px !important"), b = 0; b < a.length; b++) d = 10, a[b].setAttribute("style", "border-bottom-width:1px !important; border-radius:5px 5px 5px 5px !important"), 0 === b && (d = 0), a[b].parentElement.setAttribute("style", "margin-top:" + d + "px !important")
                };
                E.prototype.setStyleToMultipleAgent = function() {
                    var a, b, d;
                    if (this.messagePreviewContainer && this.container)
                        for (a = this.messagePreviewContainer.getElementsByClassName("messageBody"), b = this.container.documentRef.getElementById("actionsContainer"), d = this.container.documentRef.getElementById("textareaWrapper"), this.quickReplyContainer.style.marginTop = "0px", b.setAttribute("style", "border-radius:0px 0px 5px 5px !important; background-color: #f8f8f8"), d.setAttribute("style", "border-radius:0px 0px 5px 5px !important"), b = 0; b < a.length; b++) 0 === b ? 1 === this.messagePreviewCount ? a[b].setAttribute("style", "border-bottom-width: 3px !important; border-radius:5px 5px 0px 0px !important") : a[b].setAttribute("style", "border-bottom-width:1px !important; border-radius:5px 5px 0px 0px !important") : (b === a.length - 1 ? a[b].setAttribute("style", "border-bottom-width:3px !important; border-radius:0px 0px 0px 0px !important") : a[b].setAttribute("style", "border-bottom-width:1px !important; border-radius:0px 0px 0px 0px !important"), a[b].parentElement.setAttribute("style", "margin-top:0px !important"))
                };
                ...
                E.prototype.appendCallRequest = function(a) {
                    ...
                    b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed ? b.chatHandler.webrtcWin.focus() : (c = c.replace(/__IMAGE_URL__/, d), c = c.replace(/__INCOMING_CALL__/, b.languageParser.translate("chat", "incoming_call_message", {
                        name: a.n
                    })), c = c.replace(/__ACCEPT_CALL__/, b.languageParser.translate("chat", "accept_call")).replace(/__DECLINE_CALL__/, b.languageParser.translate("chat", "decline_call")), a = new C("incoming-call"), a.template = c, a.buildView(), this.messagePreviewContainer.insertBefore(a.elementReferrer, this.messagePreviewContainer.firstElementChild), a.elementReferrer.style.marginBottom = 0 === this.messagePreviewCount ? "0px" : "10px", this.incomingCallContainer = a, c = this.container.getElementById("accept-call"), a = this.container.getElementById("decline-call"), c && b.eventHandler.listen(c, "click", function() {
                ...
                E.prototype.appendCallInfo = function(a) {
                    if (!y) {
                        ...
                        var g = null,
                            ...
                            p = "",
                            q = null;
                        this.container && this.messagePreviewContainer && a && (m = b.languageParser.translate("chat", "missed_visitor_messagePreview"), d = (c = (g = w.agentProfiles[w.profiles[e.urid]]) && g.pi ? r.agentImgUrl + "/" + g.pi : "") ? "url('" + c + "');" : "transparent;", "transparent" !== d && (d += "background-position:0 0;background-size:28px 28px"), c = new C(s, null, {
                ...
                E.prototype.appendMessage = function(a) {
                    ...
                    }, "close-" + d.elementReferrer.id), 3 < this.messagePreviewCount && (f.isTopPositioned() ? this.removeElement(this.messagePreviewContainer.getElementsByClassName("message-preview-item")[3]) : this.removeElement(this.messagePreviewContainer.getElementsByClassName("message-preview-item")[0])), c.scrollToBottom(), m && this.addSurveyHandlers(q), this.container.restyle("height", this.container.getElementById("tawkchat-message-preview-container").offsetHeight + "px"), d.elementReferrer.className += " animate-fade-object"))
                };
                E.prototype.addSurveyHandlers = function(a) {
                    ...
                    this.container && (c = this.container.getElementById(a), c = n.getElementsByTagName(c, "input"), c.forEach(function(c, f) {
                        c.id && d.container.attachUserEventListener("click", function() {
                            d.lastRadioButton !== c.id && (d.lastRadioButton = c.id, b.chatHandler.sendMessage(c.value), b.sessionHandler.notifyWindowState("max"), b.viewHandler.scrollToBottom())
                ...
                E.prototype.removeAllElements = function() {
                    for (var a = null, b = 0, d = f.minimizedDimensions().width, k = 0; k < this.timeIntervalsArr.length; k++) clearInterval(this.timeIntervalsArr[k].timeInterval), this.timeIntervalsArr.splice(k, 1);
                    if (this.messagePreviewContainer) {
                ...
                var z = TawkClass.extend({
                    ...
                    appendAgent: function(a) {
                        ...
                        e && (c && l) && (-1 < this.chatContainer.getElementById("greetingsMainContainer").className.indexOf("minimize") && (g.style.display = "none", c.className = "show"), b.agents.agentsCount++, 1 < b.agents.agentsCount || 1 === b.agents.agentsCount && this.mainAgent && this.mainAgent.pid !== a.pid ? d.classList.remove("one-agent") : d.classList.add("one-agent"), 1 === b.agents.agentsCount ? (this.mainAgent = a, b.viewHandler.renderAgentHeader(a.pid), this.renderAgentMinimizedWidget(a.pid)) : (b.viewHandler.renderAgentHeader(a.pid), k.classList.add("multiple-agent")), b.viewHandler.openAgentList(), c = t["agent-profile"], d = t["agent-profile-image"], k = t["agent-profile-description"], e = new C("agentProfile-" + a.pid, null, {
                    ...
                    clearAgentFooter: function() {
                        ...
                        a && this.chatContainer && (d = a.getElementById("tawkchat-status-text-container"), k = a.getElementById("min-agent-profile-details"), b = a.getElementById("agent-profile-image"), (a = a.getElementById("tawkchat-status-agent-container")) || a) && (d && (d.style.display = "block"), k && (k.innerHTML = ""), b.innerHTML = "", a.style = "", a.className = "")
                    },
                    renderAgentMinimizedWidget: function(a) {
                        ...
                        d && (this.chatContainer && a) && (c = w.agentProfiles[a], a = d.getElementById("tawkchat-status-agent-container"), iconContainer = d.getElementById("tawkchat-status-icon-container"), e = d.getElementById("agent-profile-image"), tawkStatusMessage = d.getElementById("tawkchat-status-text-container"), profileDetails = d.getElementById("min-agent-profile-details"), k = d.getElementById("tawkchat-chat-indicator"), a && (this.clearAgentFooter(), d = c.pi ? r.agentImgUrl + "/" + c.pi : "", e.style.backgroundImage = d ? "url('" + d + "')" : "", e.style.boxShadow = "0px 0px 0px 1px " + f.headerTxtColor, a.className += "appear", profileDetails && (profileDetails.innerHTML = '<p class="name">' + c.n + '</p><p class="position">' + c.pst + "</p>"), tawkStatusMessage && f.isDesktopRectangle() && (tawkStatusMessage.style.display = "none"), k && "block" === k.style.display && b.viewHandler.handleIndicatorToggle(!0)))
                    },
                    ...
                    handleAcknowledgment: function(a) {
                        ...
                        if (m && a.messageId && (f = m.getElementById(a.messageId))) {
                            ...
                            c && (c.length && l && l.length) && (l = l[0], c = c[0], a.error ? l && (k = t["chat-resend-link"].replace("__MESSAGE_ID__", a.messageId).replace("__NOT_DELIVERED__", b.languageParser.translate("chat", "resend")).replace("__FAILED__", b.languageParser.translate("chat", "failed")), c.className = "messageWrapper error", l.className = "messageStatusContainer errorInMessage", l.innerHTML = k, e = n.rawDecode(c.childNodes[0].textContent || c.childNodes[0].innerText), this.scrollToBottom(), h = b.eventHandler.listen(l, b.viewHandler.clickEvent, function(d) {
                                b.eventHandler.cancelEvent(d);
                                b.chatHandler.sendMessageToServer(e, a.messageId);
                                if (g = m.getElementById("errorFor" + a.messageId)) c.className = "messageWrapper pending";
                    ...
                    appendMessage: function(a) {
                        ...
                        "c" === a.type ? (b.chatHandler.lastMessageOwner = "s" === m ? "server" : a.isPending ? b.chatHandler.lastMessageOwner : a.ownerId, "a" === m || "s" === m ? ("a" === m && (b.chatHandler.agentHasMessaged = !0, this.removeWaitTime()), d = n.escapeTemplateReplacement(x["chat-message-owner-agent"], [{
                            ...
                            textReplace: k
                        }]), a.data && "v" === m && (e = e.replace("messageBody", "messageBody file")), "s" === m && (e = e.replace("ownerNameContainer", "ownerNameContainer trigger"), e = e.replace("messageBody", "messageBody trigger"))) : "n" === a.type && (b.chatHandler.lastMessageOwner = "notif", a.isRtcError ? (k = "video" === a.rtcType ? b.languageParser.translate("chat", "video_call_error") : "screen" === a.rtcType ? b.languageParser.translate("chat", "screen_share_error") : b.languageParser.translate("chat", "voice_call_error"), e = n.escapeTemplateReplacement(t.noWebrtc, [{
                            placeholder: "__MESSAGE__",
                            textReplace: d
                        }, {
                    ...
                    updateViewByStatus: function(a) {
                        ...
                        if (f.isPopup) {
                            ...
                            document.title = c ? L.pageName() + " - " + n.rawDecode(c) : L.pageName()
                        }
                ...
                z.prototype.addProfileDetail = function(a) {
                    ...
                    a.pi || 1 < b.agents.agentsCount ? (c = new C("profileDetail", null, null, null, this.chatContainer.documentRef), k = t["agent-profile-description"], c.template = n.escapeTemplateReplacement(k, [{
                        placeholder: "__POSITION_CLASS__",
                ...
                z.prototype.renderAgentHeader = function(a) {
                    ...
                    }, null, e.documentRef), g.appendChild(c.buildView()), this.renderAgentWithPosition(a), 1 < b.agents.agentsCount && (g.style.width = 30 * b.agents.agentsCount - 10 * (b.agents.agentsCount - 1) + "px"), -1 < this.chatContainer.getElementById("greetingsMainContainer").className.indexOf("minimize") && (1 === b.agents.agentsCount && this.chatContainer.getElementById("headerAccountStateContainer").classList.remove("multiple-agent"), this.chatContainer.getElementById("shortMessage").style.display = "none"))
                };
                ...
                z.prototype.calculateOwnerNameAndMessageTimeSizeAll = function() {
                    ...
                    [].forEach.call(a.getElementsByClassName("agentChatContainer"), function(a) {
                        ...
                        c && (d && f && k) && (1 < b.agents.agentsCount && f.offsetWidth < d.offsetWidth + c.offsetWidth ? (k.style.left = 45 + c.offsetWidth + "px", k.style.right = "auto") : (k.style.right = "0", k.style.left = "auto"))
                    })
                };
                ...
                z.prototype.notifiyDepartmentIsNotOnline = function(a, c) {
                    ...
                    f && (d = f.getElementById("chatWrapper")) && (k = n.escapeTemplateReplacement(t.departmentOfflineNotification, [{
                        placeholder: "__TITLE__",
                ...
                z.prototype.setDivider = function(a, c, d) {
                    ...
                    }]), e.buildView(), g.insertBefore(e.elementReferrer, d.elementReferrer), !n.chatElementInView(e.elementReferrer) && (b.viewHandler.isMaximized || f.isPopup || f.isEmbedded) && (k = this.chatContainer.documentRef.getElementById("newMessagesBar"))) && (k.className = "visible", b.eventHandler.listen(k, this.clickEvent, function() {
                ...
                z.prototype.parseUploadedFile = function(a) {
                    ...
                    if (-1 !== ["jpeg", "png", "gif"].indexOf(a.type) && 2E6 >= a.size) {
                        ...
                        placeholder: "__FILE_DISPLAY__",
                        textReplace: '<video width="auto" height="auto" controls style="display: block; max-width: 420px; width: 100%;"><source src="' + c + '" type="' + a.mimeType + '"></source></video>'
                ...
                z.prototype.startUpload = function(a) {
                    ...
                    c = a.name || a.fileName;
                    d = n.getElementsByClassName(f.chatContainer.elementReferrer, "upload-error");
                    if (d.length)
                    ...
                    b.fileUploadHandler.getUploadHandler(function(d) {
                        ...
                        }]), f.chatContainer.getElementById("chatWrapper").innerHTML += e, g && f.scrollToBottom(), b.fileUploadHandler.uploadFile(h, a, c, function(b, d) {
                            k.value = "";
                ...
                z.prototype.updateFileProgress = function(a) {
                    ...
                    b && (180 >= a ? (b.getElementsByClassName("circle-progress-left")[0].style.transform = "rotate(" + a + "deg)", b.getElementsByClassName("circle-progress-right")[0].style.display = "none", b.getElementsByClassName("circle-progress-clip")[0].style.display = "block") : (b.getElementsByClassName("circle-progress-left")[0].style.transform = "rotate(180deg)", b.getElementsByClassName("circle-progress-right")[0].style.transform = "rotate(" + a + "deg)", b.getElementsByClassName("circle-progress-right")[0].style.display = "block", b.getElementsByClassName("circle-progress-clip")[0].style.display = "none"))
                };
                ...
                z.prototype.showCallRequest = function(a, c, d, k) {
                    ...
                    g || (c = this.ifScrollbarDown(), b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed ? b.chatHandler.webrtcWin.focus() : (g = (k = w.agentProfiles[w.profiles[k.urid]]) && k.pi ? r.agentImgUrl + "/" + k.pi : "default", e = e.replace(/__IMAGE_URL__/, g ? "url('" + g + "');" : "transparent;"), e = e.replace(/__INCOMING_CALL__/, b.languageParser.translate("chat", "incoming_call_message", {
                        name: k.n
                    })), e = e.replace(/__ACCEPT_CALL__/, b.languageParser.translate("chat", "accept_call")).replace(/__DECLINE_CALL__/, b.languageParser.translate("chat", "decline_call")), clearTimeout(this.incomingCallTimeout), g = new C("incoming-call"), g.template = e, g.buildView(), e = this.chatContainer.getElementById("chatContainer"), k = e.parentNode, e && k && (k.insertBefore(g.elementReferrer, e), e = this.chatContainer.getElementById("accept-call"), k = this.chatContainer.getElementById("decline-call"), c && this.scrollToBottom(), b.eventHandler.listen(e, this.clickEvent, function() {
                ...
                z.prototype.subscribeCallUpdate = function(a, c) {
                    ...
                    }]), d.buildView(), p.getElementById("chatWrapper").insertBefore(d.elementReferrer, p.getElementById("agentTypingContainer")), this.callData[a] = {
                        callView: d
                    });
                ...
                z.prototype.updateCallView = function(a, c) {
                    ...
                    k.ver > a.ver || (g = this.ifScrollbarDown(), k = k.callView, l = k.elementReferrer.getElementsByClassName("btn-icon")[0], callIconContainerEl = k.elementReferrer.getElementsByClassName("callIconContainer")[0], callIconContainerEl.style.backgroundColor = "#47ca2b", "ringing" === a.stts ? ("v" !== a.cllr.t && this.showCallRequest(a.clid, a.rt, a.so, a.cllr), d = b.languageParser.translate("chat", ("v" === a.cllr.t ? "visitor_" : "agent_") + "ringing")) : "in-progress" === a.stts ? (this.removeCallRequest(), d = b.languageParser.translate("chat", "ongoing_call")) : "completed" === a.stts && (e = n.parseChatTime(a.so), this.removeCallRequest(), a.f.vid || a.f.scrn || (l.style.transform = "rotate(135deg)"), callIconContainerEl.style.backgroundColor = "#e52f48", l = {
                        callId: a.clid,
                        ringTimeout: a.rt,
                        startedOn: a.so,
                        caller: a.cllr,
                        isMissed: h
                    }, c || (!b.viewHandler.messagePreview || y) || b.viewHandler.messagePreview.show(b.viewHandler.indicator.unansweredMessages, null, l), h || f ? (d = f ? b.languageParser.translate("chat", "rejected_call") : b.languageParser.translate("chat", "missed_" + ("v" === a.cllr.t ? "agent" : "visitor")), f = b.languageParser.translate("chat", "call_started_on", {
                        startedOn: e
                        ...
                        startedOn: e,
                        duration: f
                    })), (e = n.getElementsByClassName(k.elementReferrer, "callEndDetails")) && e.length && (e[0].innerHTML = f, e[0].style.display = "block")), (k = n.getElementsByClassName(k.elementReferrer, "callTitle")) && k.length && (k[0].innerHTML = d, h && (k[0].className += " missed")), this.callData[a.clid].ver = a.ver, g && this.scrollToBottom())
                };
                ...
                z.prototype.toggleGreetingsView = function(a) {
                    ...
                    a || k === f || 5 >= k - f ? 0 === c.scrollTop && -1 !== d.className.indexOf("minimize") && (d.className = d.className.replace(" minimize", ""), this.chatContainer.getElementById("agentProfileContainer").className = "", 1 === b.agents.agentsCount && this.chatContainer.getElementById("headerAccountStateContainer").classList.remove("multiple-agent"), this.chatContainer.getElementById("shortMessage").style.display = "block") : -1 === d.className.indexOf("minimize") && (d.className += " minimize", this.chatContainer.getElementById("agentProfileContainer").className = "show", 1 < b.agents.agentsCount ? this.chatContainer.getElementById("headerAccountStateContainer").classList.add("multiple-agent") : this.chatContainer.getElementById("headerAccountStateContainer").classList.remove("multiple-agent"), 0 < b.agents.agentsCount && (this.chatContainer.getElementById("shortMessage").style.display = "none"))
                };
                ...
                var M = function() {
                    ...
                    this.forms = {
                        ...
                        preChatForm: {
                            id: "preChatForm",
                            getTitle: function() {
                                return f.prechatOptions.text ? n.transformGreetings(f.prechatOptions.text) : f.isEmbedded && "page" === $_Tawk_WidgetId && pageType && "profile" === pageType ? b.languageParser.translate("form", "PreChatFormMessageProfile") : b.languageParser.translate("form", "PreChatFormMessage")
                            },
                            dynamicFields: null,
                ...
                M.prototype.handleResizeofForm = function(a) {
                    if (!(y || f.isPopup || f.isEmbedded))
                        if (!b.formHandler.currentForm || a) b.viewHandler.chatContainer.restyle("height", f.maximizedDimensions().height + "px !important");
                            ...
                            var d = 120;
                            "offlineForm" === b.formHandler.currentForm && "block" === b.viewHandler.chatContainer.getElementById("overlayOfflineForm").style.display ? c = b.viewHandler.chatContainer.getElementById("offlineForm") : n.getElementsByClassName(c, "formFrame") ? c = n.getElementsByClassName(c, "formFrame")[0] : (c = n.getElementsByClassName(c, "formTable")[0], d = 60);
                            a && (d += a.offsetHeight);
                            a = c.offsetHeight + d;
                ...
                M.prototype.attachEventListeners = function() {
                    ...
                    f && b.eventHandler.listen(f, b.viewHandler.clickEvent, function(a) {
                        if (n) return b.eventEmitter.emit(d.formView.formData.saveFunc, {}, function(a, b) {
                            d.handleAfterSave(a, {
                                serverData: b
                            })
                        });
                    ...
                    a && b.eventHandler.listen(a, b.viewHandler.clickEvent, function() {
                        m && (b.viewHandler.chatContainer.getElementById("overlayOfflineForm").style.display = "none", b.viewHandler.chatContainer.getElementById("formFieldsContainer").style.display = "block");
                    ...
                    l.forEach(function(a) {
                        if (!a.disabled) {
                            ...
                            }, "formkeypress" + a.fieldName), b.eventHandler.listen(c, "keydown", function(a) {
                ...
                M.prototype.isValidString = function(a, b, d) {
                    return d || a ? !(!a || !n.isString(a) || b && !(b && a.length <= b)) : !0
                };
                ...
                var K = TawkClass.extend({
                    init: function() {
                        ...
                        f.isDesktopRectangle() ? (this.container = new Q(n.getRandomName(), n.getGenericStyle({
                            ...
                            minwidth: this.frameWidth,
                            borderRadius: "50%"
                        }), ba, "iframe"), this.container.restyle("box-shadow", "rgba(0, 0, 0, 0.16) 0px 2px 10px 0px !important"), this.container.template = t["tawkchat-minified-iframe-element-round"], this.chatIndicator = new Q(n.getRandomName(), n.getGenericStyle({
                            zindex: "1000003",
                            margin: "0px",
                            width: "60px",
                            height: "22px",
                ...
                K.prototype.bubbleSettingsChanged = function() {
                    ...
                    b && (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.elementReferrer) && (a && (a.type && "default" !== a.type || this.bubbleContainer.elementReferrer && this.bubbleContainer.insertCssFile(".bubble-text-color{color:" + (f.chatBubble() ? f.chatBubble().fgc : "#ffffff") + ";}", !0), a && (this.bubbleContainer || (this.bubbleContainer = new Q(n.getRandomName(), n.getGenericStyle({
                        zindex: "1000000",
                        width: "146px",
                        height: "85px",
                        position: "fixed",
                        ...
                        minheight: "85px",
                        minwidth: "146px"
                    }), ba, "iframe")), this.bubbleContainer.elementReferrer || (b.viewHandler.iframeContainer.elementReferrer.appendChild(this.bubbleContainer.buildView(), !0), this.bubbleContainer.buildIframe(b.MinifiedStyle + f.minStyle())))), this.createBubble(), this.attachBubbleEvents())
                };
                ...
                K.prototype.calculateBubblePositioning = function(a, b, d, k, e, g, h) {
                    ...
                    if (f.isCenterPositioned()) {
                        ...
                        g = p - l + q
                    } else m = n.getRotateStyling("0", "0"), g = "0", f.isTopPositioned() ? (m.top = k + "px !important", m.bottom = "auto !important", h += " top ") : (m.bottom = k + "px !important", m.top = "auto !important", h += " bottom "), f.isRightPositioned() ? (m.right = d + "px !important", m.left = "auto !important", h += " right ") : (m.left = d + "px !important", m.right = "auto !important", h += " left ");
                ...
                K.prototype.createDefaultBubble = function() {
                    ...
                    var e = " default ";
                    b = T && 9 > O;
                    if (a || b) b = n.getElementsByTagName(this.bubbleContainer.documentRef, "body")[0], b.innerHTML = t["tawkchat-chat-bubble-canvas"], a && this.createCanvasChatBubble(), a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-text"), a.innerHTML = f.chatBubble().txt, a.style.color = f.chatBubble().fgc, f.isCenterPositioned() ? (f.isRightPositioned() ? (d = -90, k -= 10, f.isRTL() && (k = f.minimizedDimensions().width - 146)) : (d = 90, k = f.isDesktopRectangle() ? f.minimizedDimensions().width - 146 + 10 : 10, f.isRTL() && (k = 0)), a = f.minimizedDimensions().height + this.offsetX + 2) : (k = f.minimizedDimensions().height + this.offsetY + 2, a = !f.isRightPositioned() && !f.isRTL() || f.isRightPositioned() && f.isRTL() ? f.isDesktopRectangle() ? f.minimizedDimensions().width - 146 + 16 : 10 : 0), f.isRTL() && (e += " rtl-direction"), this.calculateBubblePositioning(146, 85, a, k, 0, d, e)
                };
                K.prototype.createImageBubble = function() {
                    ...
                    var e = f.chatBubble(),
                        g = e.height + 16,
                        h = 0;
                    "gallery" === e.type ? (b = parseInt(e.name, 10), k = 22 === b, f.isDesktopRectangle() || (b += "-r"), f.isCenterPositioned() ? (b += f.isRightPositioned() ? "-cr" : "-cl", f.isDesktopRectangle()) : b = f.isTopPositioned() ? b + (f.isRightPositioned() ? "-tr" : "-tl") : b + (f.isRightPositioned() ? "-br" : "-bl"), a = " gallery ", b = "https://static-v.tawk.to/a-v3/images/bubbles/" + b + (k ? ".png" : ".svg"), f.isCenterPositioned() && 0 === e.rotate && (a += " center-right"), d.innerHTML = n.escapeTemplateReplacement(t["tawkchat-chat-bubble-gallery"], [{
                    ...
                    f.isTopPositioned() || f.isCenterPositioned() ? (h += e.topOffset, f.isCenterPositioned() && 0 === e.rotate && (h -= 16)) : h += e.bottomOffset;
                ...
                K.prototype.toggleBubble = function() {
                    f.chatBubble && (this.bubbleContainer && this.bubbleContainer.elementReferrer) && (this.shown && "offline" !== r.pageStatus() ? this.bubbleContainer.restyle("display", "block !important") : this.bubbleContainer.restyle("display", "none !important"))
                };
                K.prototype.agentBarChanged = function(a) {
                    ...
                    }), h = T && 10 > O, closeIconWidth = 16, minWidth = f.minimizedDimensions().width, minHeight = f.minimizedDimensions().height, b = f.chatBubble(), d = a - minHeight, l = b.rotate, b.type && "default" !== b.type ? (k = b.topOffset, e = b.bottomOffset, bubbleWidth = b.width, bubbleContainerHeight = b.height + closeIconWidth, g = f.isRightPositioned() ? b.rightOffset : b.leftOffset) : (bubbleWidth = 146, bubbleContainerHeight = 85, f.isCenterPositioned() ? (g = minHeight + 2, l = f.isRightPositioned() ? -90 : 90) : (k = minHeight + 2, e = minHeight + 2, g = f.isRightPositioned() ? 0 : minWidth - bubbleWidth + closeIconWidth)), f.isCenterPositioned() ? (k = -0.5 * minWidth + 0.5 * a + "px !important", g += d, d = 0 === l ? g + "px !important" : -1 * (0.5 * (bubbleWidth - bubbleContainerHeight) - g) + "px !important", f.isRightPositioned() ? (this.container.restyle("right", k), m.right = d, h && (this.container.restyle("right", a - minWidth + "px !important"), 0 !== l && (m.right = g - (bubbleWidth - bubbleContainerHeight) + "px !important"))) : f.isCenterPositioned() || (this.container.restyle("left", k), m.left = d, h && (this.container.restyle("left", "0px !important"), 0 !== b.rotate && (m.left = g + "px !important"))), h ? this.container.restyle("margin", -0.5 * minWidth + "px 0 0 0 !important") : this.container.restyle("margin", -0.5 * a + "px 0 0 0 !important")) : f.isCenterPositioned() || (f.isTopPositioned() ? m.top = k + d + "px !important" : m.bottom = e + d + "px !important"), this.bubbleContainer && (this.bubbleContainer.elementReferrer && f.chatBubble && !r.chatBubbleClosed()) && this.bubbleContainer.massRestyle(m))
                };
                ...
                var W = TawkClass.extend({
                    ...
                    toggleEmojiAction: function() {
                        ...
                        f.showEmoji() ? (e.innerHTML = t.loader, d.style.display = "block", n.addClass(c, "with-emoji"), "undefined" === typeof H && gb(this.container.documentRef), this.container.attachUserEventListener(b.viewHandler.clickEvent, function(c) {
                ...
                var pa = W.extend({
                    init: function() {
                        ...
                        b.eventEmitter.on("formClosed", function() {
                            ...
                            if (c)
                                ...
                                else if (a.setChatGreetings(!0), c.style.display = "block", a.wrapper.removeClass("noMenu"), b.viewHandler.checkSeenMessageViewport(), !y && a.container.getElementById("chatTextarea") && "max" === r.chatWindowState() && b.viewHandler.userAction) {
                        ...
                        b.eventEmitter.on("formOpened", function() {
                            a.container && a.container.getElementById("chatPanel") && ("preChatForm" !== b.formHandler.currentForm && "offlineForm" !== b.formHandler.currentForm && "consentForm" !== b.formHandler.currentForm || a.wrapper.addClass("noMenu"), a.container.getElementById("chatPanel").style.display = "none")
                        });
                        b.eventEmitter.on("localeChanged", function() {
                            a.insertText();
                            a.setLinkTitle();
                    ...
                    insertText: function() {
                        ...
                        if (this.container) {
                            ...
                            this.container.getElementById("soundOff").innerHTML = b.languageParser.translate("menu", "sound_off");
                            ...
                            a = n.getElementsByClassName(this.container.getElementById("chatContainer"), "closeNotification");
                    ...
                    attachEvents: function() {
                        ...
                        this.container.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
                            f.whiteLabel() || (f.brandingRedirect() ? g.open("https://ref.tawk.to/?utm_source=visitor-widget&utm_medium=link&utm_campaign=referral&utm_term=" + L.pageId) : c.style.display = "block")
                ...
                pa.prototype.setLinkTitle = function() {
                    this.container && (this.container.getElementById("ratePositive").setAttribute("title", b.languageParser.translate("rollover", "positiveRating")), this.container.getElementById("rateNegative").setAttribute("title", b.languageParser.translate("rollover", "negativeRating")), this.container.getElementById("screenShare").setAttribute("title", b.languageParser.translate("rollover", "screenShare")), this.container.getElementById("voiceCall").setAttribute("title", b.languageParser.translate("rollover", "voiceCall")), this.container.getElementById("videoCall").setAttribute("title", b.languageParser.translate("rollover", "videoCall")), this.container.getElementById("chatMenu").setAttribute("title", b.languageParser.translate("rollover", "chatMenu")), this.container.getElementById("viewEmoji").setAttribute("title", b.languageParser.translate("chat", "insert_emoji")), f.isEmbedded || this.container.getElementById("minimizeChat").setAttribute("title", b.languageParser.translate("form", "CloseButton")))
                };
                ...
                var F = z.extend({
                    init: function() {
                        ...
                        this.resizeFromTop = new C(n.getRandomName(), n.getGenericStyle({
                            height: "6px",
                            width: "100%",
                            right: "0px",
                            top: "0px",
                        ...
                        f.maxStyle.subscribe(function() {
                            e && e.container.elementReferrer && (e.container.insertCssFile(f.maxStyle(), !0), e.wrapper.removeClass("black"), e.wrapper.removeClass("white"), e.wrapper.addClass(n.getContrast(f.headerTxtColor)))
                        });
                    ...
                    insertFrameStyle: function() {
                        ...
                        f.isTopPositioned() ? (a = "transform:translate(0, -30px);", b = "transform:translate(0, 0px);") : f.isCenterPositioned() ? (a = f.isRightPositioned() ? "transform:translate(30px,0);" : "transform:translate(-30px,0);", b = "transform:translate(0px,0);") : (a = "transform:translate(0, 30px);", b = "transform:translate(0, 0px);");
                ...
                F.prototype.calculateWidgetPosition = function() {
                    var a, b, d = Math.max((document.documentElement.clientHeight, g.innerHeight || 0) / 2) - f.maximizedDimensions().height / 2,
                        e = {};
                ...
                F.prototype.maximizeWidget = function() {
                    ...
                    e.show();
                    p && p.container && (f.isDesktopRectangle() ? p.hide() : (p.shown || p.show(), a && c && (n.removeClass(c, "appear"), n.addClass(c, "hide"), n.removeClass(a, "hide"), n.addClass(a, "appear")), p.hideBubble(), n.addClass(p.container.getElementById("tawkchat-minified-box"), "open")));
                    this.isMaximized = !0;
                ...
                F.prototype.minimizeWidget = function() {
                    ...
                    if (!f.isPopup && !f.isEmbedded) {
                        ...
                        b && d && (n.removeClass(d, "hide"), n.addClass(d, "appear"), n.removeClass(b, "appear"), n.addClass(b, "hide"), n.removeClass(a, "open"));
                        p.show();
                ...
                F.prototype.popoutWidget = function() {
                    ...
                    this.popoutWin && !this.popoutWin.closed && this.popoutWin.focus ? this.popoutWin.focus() : (f.whiteLabel() && f.whiteLabel().chatUrl && (a = f.whiteLabel().chatUrl + "/chat/"), this.popoutWin = g.open(a + $_Tawk_WidgetId + "?$_tawk_sk=" + r.sessionKey + "&$_tawk_tk=" + r.transferKey + "&v=" + r.serverVersion, "Tawk", "height=500, width=450, resizable=yes, toolbar=no, location=no, menubar=no, personalbar=no"))
                };
                ...
                F.prototype.begin = function() {
                    var a = this,
                        ...
                        d;
                    b.main.started || (this.iframeContainer && (d = document.getElementById(this.iframeContainer.elementId)), d && d.parentNode.removeChild(d), f.isEmbedded && c ? (c.appendChild(this.iframeContainer.elementReferrer), b.eventHandler.listen(g, "resize", function() {
                ...
                F.prototype.onHeaderMouseDown = function(a, c, d) {
                    ...
                    h.id !== this.resizeFromLeft.elementId && h.id !== this.resizeFromRight.elementId && h.id !== this.resizeFromTop.elementId && h.id !== this.resizeFromBottom.elementId && h.id !== this.resizeTopLeft.elementId && h.id !== this.resizeBottomLeft.elementId && h.id !== this.resizeTopRight.elementId && h.id !== this.resizeBottomRight.elementId || (1 === a.button && !g.event && !e.documentRef.event || 1 < a.button) || (b.eventHandler.cancelEvent(a), this.overlayElement.restyle("display", "block !important"), a = this.getActualViewportDimensions(), this.actualViewPortWidth = a.width, this.actualViewPortHeight = a.height, this.startOffsetY = this.startOffsetX = 0, this.mouseMovehandler = b.eventHandler.listen(document, "mousemove", function(a) {
                ...
                F.prototype.redrawIE = function() {
                    "explorer" === N && (this.iframeContainer.restyle("visibility", "hidden !important"), this.iframeContainer.restyle("visibility", "visible !important"))
                };
                F.prototype.setResizedDimensions = function(a, c, d) {
                    ...
                    d && ("bottom" === d ? (d = parseInt(g.style.bottom.replace("px", "")), a = this.actualViewPortHeight - a.clientY, 0 > a && (a = 0), d = parseInt(n.computedStyle(this.chatContainer.elementReferrer, "height").replace("px", ""), 10) - (a - d), 330 > d ? d = 330 : (a > this.actualViewPortHeight - d - 1 && (a = this.actualViewPortHeight - d - 1), g.style.cssText += ";bottom:" + a + "px !important", this.startOffsetY = d)) : (startOffsetY = parseInt(n.computedStyle(g, "bottom").replace("px", ""), 10), d = this.actualViewPortHeight - a.clientY - startOffsetY, this.startOffsetY = this.startY - startOffsetY), 330 <= d && 0 < this.actualViewPortHeight - (d + parseInt(n.computedStyle(g, "bottom").replace("px", ""), 10)) && this.setHeight(d), b.viewHandler.adjustEmojiContainerHeight());
                    h && this.scrollToBottom();
                ...
                F.prototype.onWindowResizeTimeout = function() {
                    ...
                    l + f > a && (f = a - l, 0 > f && (l += f, f = 0, this.setHeight(l)), this.isBottom ? d.style.bottom = f + "px" : d.style.top = f + "px");
                ...
                F.prototype.resetFrameDimensions = function() {
                    var a = parseInt(n.computedStyle(this.chatContainer.elementReferrer, "width").replace("px", ""), 10),
                        b = parseInt(n.computedStyle(this.chatContainer.elementReferrer, "height").replace("px", ""), 10);
                    e.frameWidth = a + "px";
                    e.frameHeight = b + "px"
                };
                ...
                F.prototype.styleAgentBar = function() {
                    ...
                    if (c) {
                        ...
                        try {
                            ...
                            q.handleError("headerAccountStateContainer is null", d.fileName, d.lineNumber, d.stack)
                        }
                    }
                };
                ...
                F.prototype.resetView = function() {
                    var a, b, d, f, e;
                    if (f = this.chatContainer) a = f.getElementById("chatWrapper"), d = f.getElementById("agentList"), e = f.getElementById("agentBar"), f = f.getElementById("expandableLink"), a && (b = a.lastChild, a.innerHTML = "", a.appendChild(b)), d && (d.innerHTML = ""), e && (a = e.parentNode.childNodes[0], e.className = "", a && -1 !== a.className.indexOf("agentWrapper") && a.parentNode.removeChild(a)), f && (f.style.visibility = "hidden", f.className = ""), this.show()
                };
                ...
                var hb = F.extend({
                    ...
                    ia = function() {
                        ...
                        f.isCenterPositioned() && "rectangle" === f.mobileWidget() && (f.isRightPositioned() ? (c.transform = "rotate(-90deg)", c.right = "0px") : (c.left = "0px", c.transform = "rotate(90deg)"));
                ...
                ia.prototype.buildView = function() {
                    ...
                    b.MinifiedMobileStyle = b.MinifiedMobileStyle.replace(/#bottomContainer/g, "#" + b.viewHandler.bottomContainerName);
                ...
                var B = function(a) {
                    ...
                    arguments.length && (this.browser = a, this.metaContent = this.getMetaContent(), this.landscape = !1, this.zoom = 1, this.resizeTimeout = this.hasKeyboard = this.minAndMaxScalesAreEqual = this.hasViewportHeightWidth = this.hasInitialScale = !1, this.removeAgentNotification = !0, this.clickEvent = "touchend", this.hasChatStarted = this.isMaximized = this.isBottomWidget = !1, this.originalDocumentStyle = null, this.isTherePreChat = f.showPreChatForm, this.noZoomMetaTag = null, this.isIndicatorOn = !1, this.scrollTop = this.scrollLeft = 0, this.mainAgent = null, this.shapeChanged(), this.minifiedWidget = new ia, e = new pa(this.tawktoLinkName, this.bottomContainerName), e.wrapper.addClass("mobile"), this.iframeContainer = new C("tawkchat-container", "border: 0 none !important; padding: 0 !important; margin: 0 !important; z-index: 999999999 !important; overflow : visible !important; min-width: 0 !important; min-height: 0 !important; max-width: none !important; max-height: none !important; width : auto !important; height : auto !important;"), this.indicator = new oa(this.minifiedWidget.container), this.iframeContainer.addChildViews([this.minifiedWidget.container, e.container]), "#max-widget" === g.location.hash && (g.history ? g.history.replaceState({}, document.title, ".") : g.location.hash = ""), this.iframeContainer.buildView(), this.chatContainer = e.container, b.eventEmitter.on("resizeIframeHeight", function() {
                        ...
                        !f.isPopup && (c.isMaximized && "#max-widget" !== g.location.hash) && r.chatWindowState("min")
                ...
                B.prototype.begin = function() {
                    ...
                    if ("symbian" === this.browser || "ie" === this.browser || "opera" === this.browser || "android2.3" === this.browser) this.clickEvent = "click";
                ...
                B.prototype.show = function() {
                    ...
                    this.isMaximized ? (this.iframeContainer.massRestyle({
                        ...
                        right: "0px",
                        bottom: "0px"
                    }), this.isMobileOptimizedWebsite() || null === this.noZoomMetaTag || (this.metaContent || "" !== this.noZoomMetaTag.content ? this.metaContent && !this.hasNoScale && a && a.setAttribute("content", this.metaContent + ", user-scalable=no") : (this.noZoomMetaTag.content = "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no", this.noZoomMetaTag.parentNode || document.getElementsByTagName("head")[0].appendChild(this.noZoomMetaTag))), this.isVisibilityToggled || (this.iframeContainer.show(), this.chatContainer.show()), this.minifiedWidget.container.hide(), "max" !== r.chatWindowState() && b.sessionHandler.notifyWindowState("max"), b.viewHandler.newMessageNotSeen && setTimeout(function() {
                        b.viewHandler.checkUnseenMessages()
                    }, 0)) : (this.isMobileOptimizedWebsite() ? (this.getZoom(), this.renderMinifiedBox()) : this.metaContent && !this.hasNoScale ? a && a.setAttribute("content", this.metaContent) : this.noZoomMetaTag.parentNode && (this.noZoomMetaTag.content = "", document.getElementsByTagName("head")[0].removeChild(this.noZoomMetaTag)), n.blurElements(e.container.documentRef.body.getElementsByTagName("input")), n.blurElements(e.container.documentRef.body.getElementsByTagName("textarea")), this.isVisibilityToggled || (this.minifiedWidget.container.show(), this.showWidget()), this.resetOriginalStyle(), this.indicator.initIndicator(), "min" !== r.chatWindowState() && b.sessionHandler.notifyWindowState("min"), this.resizeHandler(), l.triggerApiHandlers("onChatMinimized"));
                ...
                B.prototype.showWidget = function() {
                    ...
                    if (this.isMaximized) {
                        ...
                        this.scrollTop = void 0 !== g.pageYOffset ? g.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
                        this.scrollToBottom();
                        ...
                        this.iframeContainer.documentRef.body.style.setProperty("position", "fixed", "important");
                        e.container.show()
                    } else {
                ...
                B.prototype.resizeHandler = function() {
                    var a = this;
                    "offline" === r.pageStatus() && f.hideWidgetOnOffline || this.isMaximized || (clearTimeout(this.resizeTimeout), this.resizeTimeout = setTimeout(function() {
                        var b = a.isLandscape(),
                            d = a.ifScrollbarDown();
                ...
                B.prototype.getMetaContent = function() {
                    var a, b, d = document.getElementsByTagName("meta"),
                        f = "";
                    a = 0;
                    for (b = d.length; a < b; a++) d[a].getAttribute("name") && "viewport" === d[a].getAttribute("name").toLowerCase() && (f = d[a].getAttribute("content"));
                    return f
                };
                ...
                B.prototype.resizeMobileRectangleWidget = function() {
                    ...
                    "rectangle" === f.mobileWidget() && (a.style.width = "", this.minifiedBoxWidth = a.offsetWidth + 30, 110 > this.minifiedBoxWidth ? this.minifiedBoxWidth = 110 : !this.isLandscape() && this.minifiedBoxWidth > screen.width ? (this.minifiedBoxWidth = screen.width - 30, a.style.width = "calc(100% - 30px)") : this.isLandscape() && this.minifiedBoxWidth > e && (this.minifiedBoxWidth = e - 30, a.style.width = "calc(100% - 30px)"), !this.isLandscape() && this.minifiedBoxWidth > screen.width - 30 ? this.minifiedBoxWidth = screen.width - 30 : this.isLandscape() && this.minifiedBoxWidth > e - 30 && (this.minifiedBoxWidth = e - 30 - 10), d.style.width = this.minifiedBoxWidth + "px", f.isRTL() ? b.style.right = this.minifiedBoxWidth - 17 + "px" : b.style.left = this.minifiedBoxWidth - 17 + "px")
                };
                ...
                B.prototype.updateWidgetPosition = function(a) {
                    ...
                    this.iframeContainer && (f.isCenterPositioned() ? (b.top = "50% !important", b.bottom = "auto !important", b.margin = this.isMinifiedRound ? -0.5 * a + "px 0 0 0 !important" : -0.5 * a - (this.defaultHeight - 37) / 2 + "px 0 0 0 !important") : (b.margin = "0 !important", f.isTopPositioned() ? (b.top = "0px !important", b.bottom = "auto !important", d.top = this.isMinifiedRound ? "20px !important" : "-10px !important") : (b.bottom = "0px !important", b.top = "auto !important", d.bottom = this.isMinifiedRound ? "14px !important" : "0px !important")), f.isRightPositioned() ? (b.right = "0px !important", b.left = "auto !important", d.right = this.isMinifiedRound ? "20px !important" : "15px !important") : (b.left = "0px !important", b.right = "auto !important", d.left = this.isMinifiedRound ? "20px !important" : "15px !important"), this.iframeContainer.massRestyle(b), this.minifiedWidget.container.massRestyle(d))
                };
                ...
                var la = z.extend({
                    ...
                    updateViewByStatus: function(a) {
                        this._super(a);
                        e && ("preChatForm" !== b.formHandler.currentForm && "offlineForm" !== b.formHandler.currentForm) && f.isPopup && (a = m.getShortMessage(a), document.title = a ? L.pageName() + " - " + n.rawDecode(a) : L.pageName())
                    },
                    handleEndChat: function() {
                        e.chatEnded();
                        this.hideWidget()
                ...
                ya.prototype.inactivityTimeoutHandler = function() {
                    b && (b.socketManager.disconnectConnector(), f.isEmbedded ? b.formHandler.openForm("inactivityOverlay") : r.chatWindowState("min"), y ? (b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, "touchmove", this.reconnectOnActivity, "acitmmousemove"), b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, b.viewHandler.clickEvent, this.reconnectOnActivity, "acitmclick"), b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, "keydown", this.reconnectOnActivity, "acitmkeydown"), b.eventHandler.listen(document, "touchmove", this.reconnectOnActivity, "acitmousemove"), b.eventHandler.listen(document, b.viewHandler.clickEvent, this.reconnectOnActivity, "acitclick"), b.eventHandler.listen(document, "keydown", this.reconnectOnActivity, "acitkeydown")) : (b.eventHandler.listen(document, "mousemove", this.reconnectOnActivity, "acitmousemove"), b.eventHandler.listen(document, "click", this.reconnectOnActivity, "acitclick"), b.eventHandler.listen(document, "keydown", this.reconnectOnActivity, "acitkeydown"), document.onfocusin ? b.eventHandler.listen(document, "focusin", this.reconnectOnActivity, "acitfocus") : b.eventHandler.listen(g, "focus", this.reconnectOnActivity, "acitfocus")), b.viewHandler.indicator.pageTitleNotification.off())
                };
                ...
                ya.prototype.setupListeners = function() {
                    y ? (b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, "touchmove", this.onActivityHandler, "acmmousemove"), b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, b.viewHandler.clickEvent, this.onActivityHandler, "acmclick"), b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, "keydown", this.onActivityHandler, "acmkeydown"), b.eventHandler.listen(document, "touchmove", this.onActivityHandler, "acmousemove"), b.eventHandler.listen(document, b.viewHandler.clickEvent, this.onActivityHandler, "acclick"), b.eventHandler.listen(document, "keydown", this.onActivityHandler, "ackeydown")) : f.isPopup ? (document.onfocusin ? (b.eventHandler.listen(document, "focusin", this.popupOnFocusHandler, "acfocus"), b.eventHandler.listen(document, "focusout", this.popupOnBlurHandler, "acblur")) : (b.eventHandler.listen(g, "focus", this.popupOnFocusHandler, "acfocus"), b.eventHandler.listen(g, "blur", this.popupOnBlurHandler, "acblur")), b.eventHandler.listen(document, "click", this.popupOnFocusHandler, "acphclick"), b.eventHandler.listen(document, "keydown", this.popupOnFocusHandler, "acphkeydown")) : (b.eventHandler.listen(document, "mousemove", this.onActivityHandler, "acmousemove"), b.eventHandler.listen(document, "click", this.onActivityHandler, "acclick"), b.eventHandler.listen(document, "keydown", this.onActivityHandler, "ackeydown"))
                };
                var ma = function() {
                    var a = this;
                ...
                Z.prototype.startRegister = function() {
                    ...
                    !a || 1E3 < (new Date).getTime() - (new Date(a)).getTime() ? (ea.setHTTPCookie("TawkConnectionTime", (new Date).getTime(), !0), this.connectionCookieInterval = setInterval(function() {
                ...
                na.prototype.getLongMessage = function(a) {
                    var b = null;
                    "online" === a && f.onlineGreeting ? b = f.onlineGreeting.longMessage : "away" === a && f.awayGreeting ? b = f.awayGreeting.longMessage : f.offlineOptions && (b = f.offlineOptions.text);
                ...
                var fa = function() {
                    ...
                    b.eventEmitter.on("requestEmailTranscript", function(a, d) {
                        ...
                        b.chatHandler.hasChatEnded ? b.socketManager.sendToConnector("notifyEndChatTranscript", a, d) : b.socketManager.sendToConnector("notifyEmailTranscript", a, d)
                    })
                };
                ...
                var U = function() {
                    ...
                    b.eventEmitter.on("pageStatusUpdated", function(a) {
                        var d;
                        a && (d = a.ast) && (n.isString(d) && n.isArray(a.dptst)) && a.asver > r.pageStatusVersion && (b.scheduler.originalPageStatus = a.ast, r.pageStatusVersion = a.asver, r.departments = a.dptst, r.pageStatus(a.ast), b.scheduler.calculate())
                    });
                ...
                J.prototype.parseHistory = function(a) {
                    ...
                    c = e;
                    for (d = w.chatHistory.length; c < d; c++) e = w.chatHistory[c], e.md && (!e.md || e.md.ao) || a && g && g.timeStamp > (new Date(e.co)).getTime() || ("v" !== e.ut || (this.visitorHasMessaged || "c" !== e.t) || (h = (new Date).getTime() - n.getMilliseconds(e.co)), "WEBRTC_CALL" === e.m && e.md && e.md.webrtc ? (this.hasWebRTCall = !0, b.viewHandler.subscribeCallUpdate(e.md.clid, !0)) : this.prepareMessage(e, !0, !1, !1));
                    this.noRedraw = !1;
                ...
                J.prototype.handleMessageFromServer = function(a) {
                    ...
                    "WEBRTC_CALL" === a.m && a.md && a.md.webrtc ? this.hasWebRTCall = !0 : "CHAT_ENDED" !== a.m || this.hasChatEnded ? ("v" === a.ut && "c" === a.t && b.viewHandler.addWaitTime(), f.isPopup || ("c" !== a.t || b.viewHandler.isMaximized || "v" === a.ut || f.isEmbedded || !y) || (b.viewHandler.hasChatStarted = !0), w.chatVersion = a.cver, "s" === a.ut || ("c" !== a.t || this.hasChatStarted()) || (this.hasChatStarted(!0), l.triggerApiHandlers("onChatStarted", {
                        chatId: w.chatId
                    })), "c" === a.t ? "a" === a.ut ? a.md && a.md.file ? l.triggerApiHandlers("onFileUpload", "https://tawkto.link/" + a.md.file.name) : l.triggerApiHandlers("onChatMessageAgent", a.m) : "s" === a.ut && l.triggerApiHandlers("onChatMessageSystem", a.m) : "n" === a.t && ("AGENT_JOIN_CONVERSATION" === a.m ? (a.md && (a.md.pi && a.md.pi.length) && (c = "https://s3.amazonaws.com/talk-pi/" + a.md.pi), l.triggerApiHandlers("onAgentJoinChat", {
                        name: a.n,
                        position: a.md.pst,
                        image: c,
                        id: a.uid
                ...
                J.prototype.createUrl = function(a, c) {
                    ...
                    var e, g, h;
                    g = 0;
                    for (h = a.length; g < h; g++) - 1 !== a[g].indexOf(n.br) ? (e = a[g].split(n.regBr), a[g] = this.createUrl(e, n.br)) : a[g].match(n.regEmailMatch) ? a[g] = a[g].replace(n.regEmailMatch, f) : (a[g] = a[g].replace(n.regMatchUrl, d), a[g] = a[g].replace(n.regMatchIp, d));
                    return a.join(c)
                };
                ...
                J.prototype.sendTextPreview = function(a) {
                    ...
                    if (13 === a.keyCode && !a.shiftKey && !y) return b.eventHandler.cancelEvent(a), d = n.trim(c.value), c.value = "", this.sendMessage(d);
                ...
                X.prototype.init = function() {
                    var a, c;
                    if ("XMLHttpRequest" in g && "withCredentials" in new XMLHttpRequest && (x.cookieEnabled && !this.isDocumentReady) && (this.isDocumentReady = !0, c = n.parseQueryString(), !c.$_tawk_beacon && "operamini" !== y)) {
                ...
                X.prototype.begin = function(a) {
                    ...
                    a.error ? "USER_ERROR" === a.error || "SERVER_DOWN" === a.error ? this.hideWidget() : h.retryRegister() : (b.activityManager.initActivityReset(), this.started ? this.reinited(a) : (this.started = !0, this.extractRegisterData(a), this.dataIsReady = !0, this.setupDone()))
                };
                X.prototype.extractRegisterData = function(a) {
                    ...
                    "max" !== f.onClickAction || y || (this.maximize = "max" === a.cw, r.chatWindowState(a.cw));
